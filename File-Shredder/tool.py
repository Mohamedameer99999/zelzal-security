...
TOOL_NAME = "File Shredder"
TOOL_TAG = "حذف آمن للملفات"
TOOL_COLOR = "#e74c3c"
...
def api_shred():
    ...
    method = data.get("method", "dod")
    passes = {"dod": 7, "nato": 3, "german": 7, "quick": 1}
    return jsonify({"status": "shredded", "method": method, "passes": passes.get(method, 3), "recoverable": False})
